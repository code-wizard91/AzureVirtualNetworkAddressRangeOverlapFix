...
- The script can be modified to apply to most azure vnet enabled resources in order to move them to a new range. Be careful and make sure you identify all the resources attached to the vnet that need to be moved before removing overlapping address ranges otherwise you will lose network connectivity to those resources!
